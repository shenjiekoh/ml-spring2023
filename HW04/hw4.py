# -*- coding: utf-8 -*-
"""Copy of ML2023_hw04.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yRJlzBY8_d7veBo2qaFs7zjbGBOWtO7h
...
class Classifier(nn.Module):
	def __init__(self, d_model=200, n_spks=600, dropout=0.25):
		super().__init__()
		...
		self.encoder_layer = nn.TransformerEncoderLayer(
			d_model=d_model, dim_feedforward=400, nhead=8
		)
